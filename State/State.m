...
x = [q1 dq1 q2 dq2 q3 dq3 dq4];
f = [dq1 a1 dq2 a2 dq3 a3 a4];
u = [u1 u2 u3];
...
%% up
Q = [
     1e-20 0 0 0 0 0 0; % q1
     0 13 0 0 0 0 0; % dq1
     0 0 10 0 0 0 0; % q2
     0 0 0 1 0 0 0; % dq2
     0 0 0 0 10 0 0; % q3
     0 0 0 0 0 1 0; % dq3
     0 0 0 0 0 0 1e-10 % dq4
    ];
